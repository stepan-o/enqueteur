# Deprecated shim — real implementation lives in loopforge.psych.supervisor_weather
from __future__ import annotations

from loopforge.psych import supervisor_weather as _core  # pragma: no cover
