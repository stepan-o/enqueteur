...
WorldSnapshot, AgentSnapshot & StageEpisodeV2
...
map cleanly to Rust structs with Vecs and enums,
...
Iterate entities in deterministic order (e.g. by EntityID).
...
Return a fully populated WorldSnapshot.
