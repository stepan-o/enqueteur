...
* **Story first, infra second.** Every phase must make episodes more interesting to _watch_ or easier to _understand_.
* **Layer discipline.**
...
This is the “we’re still in back-of-house, but we’re thinking like theater now” phase.

### What it aims to accomplish
**1. Canonize the Stage data contract**
...
**3. Producer Console (non-LLM first)**
* Controls for:
...
> 🟥 Feels like: “This is a mini-arc, not just a sprint,” but it’s where Loopforge becomes a _playable_ drama machine.

---

## Phase 4 — Cinematic & Multi-Renderer Upgrade

**“From dashboard to actual theater.”**
...
**4. Installation / Performance Mode**
* Full-screen, autoplaying episodes.
